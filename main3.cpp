...
int main(int argc, char **argv)
{
	...
	sceneObjects[3]->Scale(glm::vec3(5.0, 5.0, 0.1f));
	sceneObjects[3]->Translate(glm::vec3(0.0f, -3.0f, 0.0f));
	sceneObjects[3]->Rotate(glm::vec3(1.0, 0.0, 0.0), glm::radians(90.0f));

	sceneObjects[4]->Translate(glm::vec3(0.0f, 0.0f, -5.0f));
	sceneObjects[4]->Scale(glm::vec3(5.0f, 5.0f, 0.1f));
	...
	sceneObjects[4]->GenerateVBO(cubeMesh);

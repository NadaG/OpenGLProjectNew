...
int main(int argc, char **argv)
{
	...
	albedo = albedoTex.GenerateTexture("PBR/albedo.png");
	normal = normalTex.GenerateTexture("PBR/normal.png");
	metallic = metallicTex.GenerateTexture("PBR/metallic.png");
	roughness = roughnessTex.GenerateTexture("PBR/roughness.png");
	////////////////////////////////////////////////
